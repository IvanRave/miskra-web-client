(function(angular){
  ...
  var drct = function(){
	...
	var initMap = function($scope, lfl, elm, curLng, curLat, curZoom){
	  ...
	  var createMarker = function(mdata){
	  ...
	  var updateMarkers = function(newMarkers){
